...
public class StrassensMatrixMultiplication extends DaCSkeleton<List<int[][]>, int[][]> {
    ...
    protected Function<List<int[][]>, int[][]> getProblemSolver() {
        return StrassensMatrixMultiplication::naiveMultiply;
    }
    ...
    protected Function<List<int[][]>, List<List<int[][]>>> getSubproblemGenerator() {
        return StrassensMatrixMultiplication::createSubprolems;
    }
